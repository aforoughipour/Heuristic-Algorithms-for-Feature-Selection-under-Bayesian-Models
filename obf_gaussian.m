function [feat_rank, feat_post]=obf_gaussian(x0,x1,pf,prior)
...
%feat_rank is ranking features by their marginal posterior and feat_post is
%the marginal posterior of ranked features
...
post_f=un_post_f./(1+un_post_f);
[feat_post, feat_rank]=sort(post_f,'descend');
